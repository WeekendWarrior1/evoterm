...
class Wild:
	...
	def __init__(self, args, neurons):
		...
		self.valid_wild = [(x, y) for x, y in itertools.product(
			...
			range(1, self.args.environment + 1))]
		self.animals = self.init_animals(args, neurons)
